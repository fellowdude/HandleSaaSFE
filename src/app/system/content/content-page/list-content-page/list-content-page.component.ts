...
@Component({
  ...
  templateUrl: './list-content-page.component.html',
  styleUrls: ['./list-content-page.component.scss']
})
export class ListContentPageComponent implements OnInit {
  headerFixed = false;
  ...
  ngOnInit() {
    this.headerService.sendTitle('Contenido de páginas estáticas');
    ...
    this.gridList.config.redirect = 'system/content-page/detail/';
    this.gridList.config.entity = 'Páginas estáticas';
    this.gridList.config.entityFilter = 'static_page';
  }
